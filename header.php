	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            if(isset($_SESSION['email'])==true){ ?>
	          <li class="nav-item cta mr-md-2"><a href="job-post.php" class="nav-link"><?php if(empty($first_name)){echo $_SESSION['email'];} 
            else{ echo $first_name," ",$last_name; }  ?></a></li>
            <li class="nav-item">
            <div class="dropdown">
              <img src="admin/profile_img/<?php if(empty($img)){echo "default.png";} 
                        else{ echo $img;}   ?>" class="img-circle dropdown-toggle"
               type="button" data-toggle="dropdown" alt="Profile Pic" width="50" height="50">
              <ul class="dropdown-menu">
              <li><a href="my_profile.php">&emsp; My Profile</a></li>
              <div class="dropdown-divider"></div>
              <li><a href="admin/logout.php">&emsp; Log Out</a></li>
              </ul>
            </div>
            </li>
            <?php }
